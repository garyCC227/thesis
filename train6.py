...
# import sys
# sys.stdout = open('./code/adapted_deep_embeddings/log6.txt','wt')
...
def main():
    ...
    k= 500 #TODO
    epoch =150
    NN_layer = "587_{}classes_2denselayer_normali_{}_epoch{}_imagenet_imgaug".format(classes,k,epoch) #TODO
    BS = 8 #batch size
    print(NN_layer)
    # NN_layer = "Flaten"
