...
# import sys
# sys.stdout = open('log_train4.txt','wt')


def get_model(input_shape):
  
  base_model = ResNet50(weights=None, include_top=True, input_shape=input_shape)
...
def main():
    ...
    k= 10 #TODO
    # NN_layer = "pool_Dropout_Original_2_class_resnet_one_faltten_randomweigth" #TODO
    # NN_layer = "include_true_2classes_sigmoid_1"
    NN_layer = "Test_graph"
    print(NN_layer)
    # NN_layer = "Flaten"
    ...
    train_model=model50.fit(train_x, train_y, batch_size=8,epochs=30,verbose=1,validation_data=(val_x, val_y))
    ...
    print(classification_report(test_true, test_pred, target_names=["0","4"]))
